...
# df = pd.read_csv('Training.csv', header=None, skiprows=1, names=column)
#
...
#
# # TRAINING DATA
# tr1 = pd.read_csv("Testing.csv")
# column_test = []
# for i in tr1.columns:
#     column_test.append(i.replace("_", " "))
# tr = pd.read_csv('Testing.csv', header=None, skiprows=1, names=column_test)
...
#     sym = ['back pain', 'yellow urine', 'mild fever', 'neck pain']
#     d, c = NaiveBayes(sym)
#     dl, cl = LogisticReg(sym)
#     dd, cd = DecisionTree(sym)
#     dk, ck = knn(sym)
#     print(d, c, '\n', dl, cl, '\n', dd, cd, '\n', dk, ck)
#
